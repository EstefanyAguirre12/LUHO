...
<div class="col-sm-10">
<input type="email" class="form-control" id="inputEmail3" placeholder="elCorreoDe@tuCuenta.com">
</div>
</div>
<div class="form-group row">
<label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
<div class="col-sm-10">
<input type="password" class="form-control" id="inputPassword3" placeholder="tu contrasena">
</div>
</div>
<div class="vainas">

<a href="#" class="badge badge-info">Aun no tienes una cuenta? Registrate ahora!</a>
...
<div class="row">
<div class="col-md-12">
<h1 class="register-text">Registrate ahora! es gratis y siempre lo sera.</h1>
<br>
<form>
    <div class="form-row">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputEmail" placeholder="EjemploDe@tuCorreo.com">
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="inputPassword">Contrasena:</label>
            <input type="password" class="form-control" id="Contrasena" placeholder="Tu Contrasena">
        </div>
        <div class="form-group col-md-6">
             <label for="inputPaasword2">Confirma tu contrasena:</label>
