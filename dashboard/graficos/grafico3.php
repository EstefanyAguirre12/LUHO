...
$sql="SELECT producto.Nombre, producto.IdProducto, oferta.Descuento FROM oferta, producto WHERE producto.IdProducto=oferta.IdProducto";
$params=array(null);
...
$grafico->title->Set("Descuento de los productos");
$grafico->xaxis->title->Set("Nombre");
$grafico->xaxis->SetTickLabels($labels);
$grafico->yaxis->title->Set("Descuento");
