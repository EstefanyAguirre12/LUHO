...
$sql="SELECT producto.Nombre, producto.IdTalla, talla.Talla FROM talla, producto WHERE producto.IdTalla=talla.IdTalla";
$params=array(null);
...
$grafico->title->Set("Talla de los productos");
$grafico->xaxis->title->Set("Nombre");
$grafico->xaxis->SetTickLabels($labels);
$grafico->yaxis->title->Set("Talla");
